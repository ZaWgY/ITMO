...
public class ArithmeticCoding {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileInputStream fs = new FileInputStream("Text");
        ...
        Double CompressionRatio = (double)a.length / (encodedBits.length/8);
        Locale.setDefault(Locale.US);
        System.out.printf("%d -> %d \n", a.length, encodedBits.length / 8);
        System.out.println(Arrays.equals(a, codec.decode(encodedBits)));
        System.out.printf("Ratio = %f",CompressionRatio);
    }
}